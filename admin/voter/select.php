...
<div class="">
<?php 
echo"<div class='col-sm-2' style='float:right;margin-bottom:10px;'><form action='form.php' method='post'><input type='submit' name='view' value='Add Voter' class='form-control btn-danger'></form></div>";
?>
...
mysqli_query($con,"delete from tbl_fingerprint where user='$del_id'");
...
$row2 =mysqli_fetch_array($result2);
			...
			<td><a href='fingure.php?id=$id'>Fingure</a><br><a href='update.php?id=$id'>Data</a></td>
